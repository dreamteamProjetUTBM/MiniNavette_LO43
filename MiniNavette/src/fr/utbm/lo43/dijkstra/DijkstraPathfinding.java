...
/**
 * Classe reutilisable implementant l'algorithme de Dijkstra pour trouver le
 * plus court chemin entre deux elements de type Dijkstrable
 * 
...
public class DijkstraPathfinding<T extends Dijkstrable> {
	...
	/**
	 * Recupere le plus court chemin entre deux elements sous forme de Path (qui
	 * contient une liste et le float weight qui correspond au poids du chemin)
	 * Retourne une liste contenant un element vide et un poid de -1 dans le cas
	 * ou il n'existe aucun chemin entre les deux elements
	 * 
	 * @param start
	 *            Element de depart
	 * @param end
	 *            Element d'arrive
	 * @return liste des elements a parcourir dans l'ordre pour arriver a
	 *         l'element end
	 * 
	 */
