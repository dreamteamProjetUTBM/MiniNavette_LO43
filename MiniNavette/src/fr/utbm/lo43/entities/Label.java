...
{	
	/**
	 * Le text affich� lors du rendu du Label
	 */
	private String text;
	 ...
	 * @param _position Position de rendu du texte sur l'�cran
	 */
	...
	/**
	 * Permet de renseigner le texte qui est affich� par le Label
	...
	/**
	 * Permet de r�cup�rer le texte courant du Label
