 ...
 * Classe RailWay
 * 
 * A la mani�re des rivi�res dans mini metro, les voix ferr�es
 * repr�sentent des obstacles que les lignes ne peuvent traverser qu'avec des
 * ponts
 * 
...
public class RailWay extends Entity implements EntityDrawable {
	...
	public void render(Graphics arg2) {
		...
		for (int i = 0; i < plot.getPointCount(); ++i) {
			...
			arg2.fillOval(plot.getPoint(i)[0] - RAILWAY_THICKNESS / 2, plot.getPoint(i)[1] - RAILWAY_THICKNESS / 2,
					RAILWAY_THICKNESS, RAILWAY_THICKNESS);
		}

	}

	/**
	 * Permet de savoir si une autre instance de la classe shape est en
	 * collision avec la voie ferr�e
	 * 
	 * @param _shape
	 *            la forme � v�rifier
