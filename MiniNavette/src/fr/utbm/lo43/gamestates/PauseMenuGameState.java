...
public class PauseMenuGameState extends BasicGameState {
	...
	public void init(GameContainer arg0, StateBasedGame arg1) throws SlickException {
		back_button = new Button(new Vector2f(100, 200), "asset/b_pause_resume_idle.png",
				"asset/b_pause_resume_hover.png", "asset/b_pause_resume_pressed.png");
		...
		quit_button = new Button(new Vector2f(100, 270), "asset/b_pause_quit_idle.png", "asset/b_pause_quit_hover.png",
