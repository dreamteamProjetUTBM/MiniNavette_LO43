...
public class MainMenuGameState extends BasicGameState {
	...
	public void init(GameContainer arg0, StateBasedGame arg1) throws SlickException {
		...
		option_button = new Button(new Vector2f((Map.WIDTH / 2) - (600 / 2), 440), "asset/b_option_idle.png",
				"asset/b_option_hover.png", "asset/b_option_pressed.png");
		...
		quit_button = new Button(new Vector2f((Map.WIDTH / 2) - (600 / 2), 505), "asset/b_quit_idle.png",
				"asset/b_quit_hover.png", "asset/b_quit_pressed.png");
