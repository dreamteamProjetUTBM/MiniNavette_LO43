...
public class GameOverGameState extends BasicGameState {
	...
	public void init(GameContainer arg0, StateBasedGame arg1) throws SlickException {
		...
		btn_menu = new Button(new Vector2f(), "asset/b_go_menu_idle.png", "asset/b_go_menu_hover.png",
		...
		btn_restart = new Button(new Vector2f(), "asset/b_go_restart_idle.png", "asset/b_go_restart_hover.png",
		...
		score_label = new Label("" + Score.getInstance().getScore(),
				new Vector2f(75, Map.HEIGHT - Map.GRID_SIZE / 1.1f));
